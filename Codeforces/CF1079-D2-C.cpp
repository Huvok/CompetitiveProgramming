...
//                                                          // AUTHOR: Hugo Garcia
// Standard dp[i][j] where i is the ith key and j is the finger that played the i - 1 key.
// dpk[i][j] holds a possible answer for that state. Reconstruct accordingly.
